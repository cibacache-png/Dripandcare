    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="min-h-screen">
        ...
        <a
          ...
          className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 bg-[#25D366] text-white p-3 sm:p-4 rounded-full shadow-xl hover:scale-110 hover:shadow-2xl transition-all duration-300"
        >
        ...
        >
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 md:px-8 text-left py-12 sm:py-16 md:py-20 w-full">
            <div className="space-y-3 sm:space-y-5 md:space-y-6 max-w-2xl">
              <p className="text-sm sm:text-base md:text-lg text-white/90 leading-relaxed">
                {getText('hero', 'welcome_text', 'Bienvenidas/os a')}
              </p>
              <div className="inline-block bg-white/40 backdrop-blur-md border border-white/60 rounded-lg sm:rounded-xl px-4 sm:px-6 md:px-7 py-2.5 sm:py-3.5 md:py-4 shadow-lg text-center max-w-full">
                <h1 className="text-base sm:text-xl md:text-2xl font-light text-white font-display mb-1 sm:mb-1.5" style={{ lineHeight: '1.2' }}>
                ...
                <p className="text-[11px] sm:text-sm md:text-base font-light text-white mb-0.5 sm:mb-1" style={{ lineHeight: '1.4' }}>
                ...
                <p className="text-[9px] sm:text-xs md:text-sm font-bold text-white" style={{ lineHeight: '1.3' }}>
              ...
              <div className="flex justify-start pt-2 sm:pt-3 md:pt-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 text-sm sm:text-base bg-[#AA225D] text-white rounded-full font-medium hover:bg-[#8B1A4A] transition-all duration-300 text-center shadow-lg"
                >
          ...
          <button
            ...
            className="absolute bottom-4 sm:bottom-6 md:bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce z-10"
          >
        ...
        {/* Quién Soy */}
        <section id="quien-soy" className="flex items-center bg-[#394023]" style={{ minHeight: 'calc(100vh - 60px)', paddingTop: '2rem', paddingBottom: '2rem' }}>
        ...
        {/* Nuestros Servicios */}
        <section id="servicios" className="bg-[#F8EEEE] flex items-center" style={{ minHeight: 'calc(100vh - 60px)', paddingTop: '2rem', paddingBottom: '2rem' }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-5xl mx-auto">
            <button
              ...
              className="group rounded-xl sm:rounded-2xl bg-[#AA225D] p-5 sm:p-8 md:p-10 text-left shadow-lg hover:shadow-xl transition-all duration-300 active:scale-95 md:hover:scale-105"
            >
              <div className="w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-white/20 rounded-lg sm:rounded-xl flex items-center justify-center mb-2.5 sm:mb-4 md:mb-5">
                <Droplet className="w-5 h-5 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white" />
              </div>
              <h3 className="service-title text-lg sm:text-2xl md:text-3xl font-semibold text-white mb-1.5 sm:mb-3 md:mb-4">{getText('servicios', 'sueroterapia_title', 'Sueroterapia')}</h3>
              <p className="text-white/90 text-xs sm:text-base md:text-lg leading-relaxed mb-2.5 sm:mb-4 md:mb-5">
              ...
              <div className="flex items-center text-white font-medium text-xs sm:text-base">
                <span className="mr-2">{getText('servicios', 'sueroterapia_cta', 'Ver tratamientos')}</span>
                <ChevronRight className="w-3.5 h-3.5 sm:w-5 sm:h-5 group-hover:translate-x-2 transition-transform duration-300" />
              </div>
            </button>

            <button
              onClick={() => setShowEnfermeriaSections(!showEnfermeriaSections)}
              className="group rounded-xl sm:rounded-2xl bg-[#617E1D] p-5 sm:p-8 md:p-10 text-left shadow-lg hover:shadow-xl transition-all duration-300 active:scale-95 md:hover:scale-105"
            >
              <div className="w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-white/20 rounded-lg sm:rounded-xl flex items-center justify-center mb-2.5 sm:mb-4 md:mb-5">
                <Heart className="w-5 h-5 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white" />
              </div>
              <h3 className="service-title text-lg sm:text-2xl md:text-3xl font-semibold text-white mb-1.5 sm:mb-3 md:mb-4">{getText('servicios', 'enfermeria_title', 'Enfermería móvil')}</h3>
              <p className="text-white/90 text-xs sm:text-base md:text-lg leading-relaxed mb-2.5 sm:mb-4 md:mb-5">
        ...
        {/* Contacto */}
        <section id="contacto" className="flex items-center bg-[#617E1D]" style={{ minHeight: 'calc(100vh - 60px)', paddingTop: '2rem', paddingBottom: '2rem' }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 w-full">
          ...
          <div className="max-w-xl mx-auto">
            ...
            <div className="relative">
              <div className="bg-white/95 shadow-lg p-4 sm:p-6 md:p-8 pt-10 sm:pt-14 md:pt-16" style={{ clipPath: 'url(#tombstone-shape)' }}>
                <div className="absolute top-3 sm:top-5 md:top-6 left-1/2 transform -translate-x-1/2">
                  <Heart className="w-7 h-7 sm:w-10 sm:h-10 md:w-12 md:h-12 text-[#617E1D] fill-[#617E1D]" />
                </div>
                <div className="text-center space-y-2 sm:space-y-4 mb-4 sm:mb-6 md:mb-8 mt-4 sm:mt-6 md:mt-8">
                  <h3 className="text-sm sm:text-lg md:text-xl font-semibold text-slate-800 font-display uppercase tracking-wide px-2 leading-tight">
                    {getText('contacto', 'card_title', 'Bienestar a un mensaje de distancia')}
                  </h3>
                </div>
                <div className="space-y-1.5 sm:space-y-2.5 md:space-y-3 text-slate-600 mb-4 sm:mb-6 md:mb-8">
                  <div className="flex items-start space-x-2 sm:space-x-3">
                    <div className="w-1 h-1 sm:w-2 sm:h-2 bg-[#617E1D] rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
                    <p className="text-[11px] sm:text-sm md:text-base leading-relaxed">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 text-xs sm:text-base bg-[#617E1D] text-white rounded-full font-medium hover:bg-[#4A6217] active:scale-95 transition-all duration-300 text-center"
                >
